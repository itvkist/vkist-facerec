...
import argparse
import os
from deep3d.util import util
import deep3d.models
...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--name', type=str, default='pretrained', help='name of the experiment. It decides where to store samples and models')
        parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
        parser.add_argument('--checkpoints_dir', type=str, default='deep3d/checkpoints', help='models are saved here')
    ...
    def gather_options(self):
        ...
        model_option_setter = deep3d.models.get_option_setter(model_name)
        ...
        #     dataset_option_setter = deep3d.data.get_option_setter(dataset_name)
